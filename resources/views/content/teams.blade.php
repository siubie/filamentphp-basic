                    ...
                    <div class="pt-6 text-center">
                        ...
                        <div class="mt-2 mb-5 space-x-2">
                            @if (isset($team->twitter))
                                <a class="hover:text-blue-700" aria-label="Twitter link" href="{{ $team->twitter }}">
                            ...
                            @if (isset($team->facebook))
                                <a class="hover:text-blue-700" aria-label="Facebook link" href="{{ $team->facebook }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="inline-block" width="1rem"
                                        height="1rem" viewBox="0 0 512 512">
                                        <path fill="currentColor"
                            ...
                            @if (isset($team->instagram))
                                <a class="hover:text-blue-700" aria-label="Instagram link"
                                    href="{{ $team->instagram }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="inline-block" width="1rem"
                                        height="1rem" viewBox="0 0 512 512">
                                        <path fill="currentColor"
                            ...
                            @if (isset($team->linkedin))
                                <a class="hover:text-blue-700" aria-label="Linkedin link" href="{{ $team->linkedin }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="inline-block" width="1rem"
                                        height="1rem" viewBox="0 0 512 512">
                                        <path fill="currentColor"
